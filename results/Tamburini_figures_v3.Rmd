...
create_fig <- function(sobj_in, cols_in, type_column = "cell_type2",
                       ...
                       pt_size = 0.1, pt_outline = 0.4, cell_counts = T,
  ...
  boxes <- box_data %>%
    ...
    geom_boxplot(fill = NA, size = 0.5, outlier.size = 0.5, outlier.color = NA, width = 0.5, ymin = NA, ymax = NA, fatten = 1, color = "black") +
