...
fig3_params <- list(
  ...
  on_top     = list(
    c("CCR7hi Mig cDC2", "CCR7hi Mig cDC1", "B cell", "T cell"),
    c("CCR7hi Mig cDC2", "CCR7hi Mig cDC1", "cDC2 Tbet-", "cDC2 Tbet+", "B cell", "T cell", "NK"),
    c("Ptx3_LEC", "fLEC", "cLEC", "Collecting", "BEC", "B cell", "T cell"), 
    NULL
  )
)
