...
create_fig4 <- function(sobj_in, ova_cols, feats, feat_cols, ref_cols, pt_size = 0.00001,
                        pt_outline = 0.4, low_col = c("white", "white")) {
...
feats <- list(
  v1 = c("Ccl2", "Cxcl12",   "Msr1",   "Pkm",   "Lgals3", "Aif1"),
  v2 = c("Mif",  "Cdc42ep3", "Malt1", "Jak2", "Cd9", "Ddx6"),
  v3 = c("Skil", "Nrp2",     "Sema7a", "Phip",  "Cd53", "Cd81")
)
...
walk(feats, ~ {
  feat_cols <- get_cols(length(.x))
  feat_cols <- set_names(feat_cols, .x)
...
# Some genes were not found: Dynl12
feats <- list(
  v1 = c("Cd53", "Ywhab", "Siva1", "Rock2", "Insm1", "Cd200"),
  v2 = c("Cd53", "Ywhab", "Ccl22", "Dynll2", "Eps15", "Il21r")
)
