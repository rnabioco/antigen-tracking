...
#' 
#' @param grp_in Cell group to find cluster markers for.
#' @param sobj_in Seurat object.
#' @param grp_column meta.data column containing cell groups to use for
#' filtering for grp_in.
#' @param clust_column meta.data column containing clusters to use for finding
#' marker genes.
#' @return tibble
#' @export
find_group_markers <- function(grp_in, sobj_in, grp_column, clust_column) {
