...
# Set subtype colors
set_type_cols <- function(type, sobjs_in, type_key, type_column = "cell_type2",
                          cols_in, other_cols) {
  
  sobjs_in <- sobjs_in[type_key[names(sobjs_in)] == type]
...
create_marker_panel_v1 <- function(input_sobj, input_cols, input_umap = NULL, clust_column, order_boxes = T,
                                   ...
                                   uniq = params$uniq_GO, umap_mtplyr = 6, xlsx_name = NULL, ...) {
...
```{r, ref.label = c("Functions", "Packages", "Themes"), eval = F}
```
