...
create_bubbles <- function(GO_df, plot_colors = theme_cols[c(1:2, 4, 9)],
  ...
  GO_data <- GO_df %>%
    mutate(
      ...
      term_id = str_c(term_id, " ", !!sym(id_col)),
...
create_marker_fig <- function(input_sobj, input_markers, input_GO = NULL, type_id, 
                              ...
                              # input_umap, umap_color, fig_heights = c(0.44, 0.33, 0.23), 
...
get_marker_cols <- function(input_cols, input_marks) {
